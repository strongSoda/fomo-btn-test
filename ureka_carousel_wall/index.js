...
const carousel_controls = `<div class="d-flex justify-content-between mb-4 position-relative">
                                <a class="fomo-wall-container-control position-relative" href="javascript:void(0)" role="button" data-slide="prev" data-target="#carouselMultiItemExample">
                                  <i class="fas fa-angle-left pe-2"></i>&nbsp;<span>Previous</span>
                                </a>
                                <a class="fomo-wall-container-control position-relative" href="javascript:void(0)" role="button" data-slide="next" data-target="#carouselMultiItemExample">
...
// }
  ...
  setTimeout(() => {
    loadingText.innerHTML = 'Reviews from people nearby'
    reviewsContent.innerHTML = ''
